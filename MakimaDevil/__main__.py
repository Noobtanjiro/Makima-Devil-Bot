...
from MakimaDevil import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
                          OWNER_ID, PORT, SUPPORT_CHAT, TOKEN, URL, WEBHOOK,
                          SUPPORT_CHAT, dispatcher, StartTime, telethn, updater,pbot)
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from MakimaDevil.modules import ALL_MODULES
from MakimaDevil.modules.helper_funcs.chat_status import is_user_admin
from MakimaDevil.modules.helper_funcs.misc import paginate_modules
...
I AM A SUPER ADVANCED BOT WITH MORE THAN 100+ AWESOME FEATURES
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("MakimaDevil.modules." +
                                              module_name)
